...
public class Homework1 extends BaseClass {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 * 4) Verify customer "Susan McLaren" is present in
		 * the table 
		 * 5) Click on customer details 
		 * 6) Update customers last name and
		 * credit card info 
		...
		// this way, we cannnot click on the Susan's record.
		...
		// verify updated values in the tables
