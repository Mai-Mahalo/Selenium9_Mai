...
public class OpenFIrefoxBrowser {
	...
	public static void main(String[] args) throws InterruptedException { // need a main method if you want to open browsers.
		
		// We do not need to add JAR files for each class. 
		// We already have them in the project build path now.
		...
		driver.get("https://www.neotechacademy.com/"); // driver object
